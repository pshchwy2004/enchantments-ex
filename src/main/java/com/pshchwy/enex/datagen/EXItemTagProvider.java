...
public class EXItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
     ...
     */
    public EXItemTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
