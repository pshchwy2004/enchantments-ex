...
| Sweeping Edge EX         | Reduces air drag when flying an elytra. Additional damage dealt to all flying mobs. Nearby Phantoms and Vexes gain Wither according to level. If combined with Fire Aspect, also sets them on fire.                                                                           |
