...
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Aqua Affinity EX         | Immune to Mining Fatigue. All nearby Elder Guardians get Glowing.                                                                                                                                                                                                             |
| Bane of Arthropods EX    | Immune to Poison. Cobwebs break on contact while holding weapon.                                                                                                                                                                                                              |
| Blast Protection EX      | Nearby Creepers gain Slowness and Glowing according to the enchantment level.                                                                                                                                                                                                 |
...
| Feather Falling EX       | Safe fall distance is increased by 5*`level` blocks.                                                                                                                                                                                                                          |
...
| Loyalty EX               | When the trident hits a block, teleports any item or experience orb within 3 blocks of where the trident landed to the player who threw it.                                                                                                                                   |
...
| Projectile Protection EX | Reduces knockback, and its projectile protection now also extends to the Warden's Sonic Boom. Shulker bullets within a level-scaled range will be redirected to target its owner if the owner is alive, and will fall if the owner is dead.                                   |
...
| Silk Touch EX            | Compatible with Fortune/Fortune EX. Silk Touch properties are activated by mining a block while sneaking, and additionally enables dropping experience when mining blocks that normally drop XP.                                                                              |
| Smite EX                 | Applies Weakness V to all undead mobs and Wardens, and Weakness I to all other targets. Has a (25% * level) chance of curing a hit Zombie Villager.                                                                                                                           |
| Soul Speed EX            | Does not drain durability when walking or running on Soul Sand or Soul Soil.                                                                                                                                                                                                  |
| Sweeping Edge EX         | Additional damage dealt to all flying mobs. Nearby Phantoms and Vexes gain Wither according to level. If combined with Fire Aspect, also sets them on fire. Reduced air drag for elytras (26.2+ only).                                                                        |
| Swift Sneak EX           | Raised the maximum enchantment level to 5. Sneaking decreases Warden anger by `level` every second in a radius of `level * 10` blocks.                                                                                                                                        |
...
| Unbreaking EX            | When the item's durability decreases to 25% or lower, additional effects will be applied. Armor will grant Resistance, weapons will grant Strength, and tools will grant Haste. If the armor has Fire Protection, gains Fire Resistance. If the tool has Fortune, gains Luck. |
